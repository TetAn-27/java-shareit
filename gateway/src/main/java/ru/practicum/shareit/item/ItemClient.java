...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllUserItems(int userId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> searchForItems(int userId, String text, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
